...
export default function MemberCard({ member }: Props) {
  return (
    <div
      className={`w-[80vw] md:w-[40vw] h-full flex flex-col justify-between relative p-4  gap-12 md:gap-8 rounded-xl shadow-md overflow-hidden ${
